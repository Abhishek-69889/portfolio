...
const Nav = () => {
  ...
  return (
    <nav className="px-4 mt-5 sm:px-6 lg:px-8 mx-auto max-w-screen-md fixed top-0 left-0 right-0 z-50 rounded-2xl bg-black/20 border-2 border-pink-500/30 transition-colors duration-300">
